...
function Content() {
  return (
    <div className='w-full'>
      <div className='m-16'>
        <div className='text-3xl p-3 text-orange-600'>
        ...
        <div className='p-3'>
          ...
          <ul className='mt-4 ml-5'>
            ...
            <li>Eliminates costly skiving equipment <br />
              No-skive hose not only speeds assembly, it eliminates needing skiving equipment, wasted time and clean-up. No-skive hose assemblies are the preferred choice for all medium pressure mobile and industrial applications.</li>
          </ul>
        </div>
      </div>
    </div>
